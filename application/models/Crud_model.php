...
class Crud_model extends CI_Model{
	...
	public function mengosongkan_tabel($nama_tabel)
	{		
		$query = $this->db->truncate($nama_tabel);
		echo '<script>alert("tabel berhasil dikosongkan!")</script>';
	}

	function input_data_jadwal_algoritma_genetika($nama_tabel, $nama_penyewa, $waktu_sewa){
		$data = array(
