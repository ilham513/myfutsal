...
<html lang="en">
  <head>
    ...
    <title>Form Pesan Lapangan</title>
        ...
        <div class="card bg-light text-dark" style="border-radius: 1rem;">
          <div class="card-body p-5 text-center">
            ...
            <div class="mt-md-4 pb-4">
              ...
              <h2 class="fw-bolder mb-4 text-uppercase">Isi Data Diri Anda</h2>
			  ...
			  <form method="post" action="<?=site_url('akun/login_go')?>">
				  ...
				  <div class="form-outline form-white mb-4">
					<label class="form-label" for="typePasswordX">Nama Tim</label>
					<input type="password" name="password" id="typePasswordX" class="form-control" />
				  </div>

				  <div class="form-outline form-white mb-4">
					<label class="form-label" for="typePasswordX">Jumlah Anggota Tim</label>
					<input type="password" name="password" id="typePasswordX" class="form-control" />
				  </div>

				  <div class="form-outline form-white mb-4">
					<label class="form-label" for="typePasswordX">Nomor Telpon</label>
					<input type="password" name="password" id="typePasswordX" class="form-control" />
				  </div>

				  <button class="btn btn-primary px-5" type="submit">Pesan</button>
			  </form>
