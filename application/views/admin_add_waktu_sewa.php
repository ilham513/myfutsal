...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Tambah Waktu Sewa</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section dashboard">
		...
		<div class="card">
            <div class="card-body">
              <h5 class="card-title">Menambah Waktu Sewa</h5>

              <!-- General Form Elements -->
              <form action="<?=site_url('admin/add_waktu_sewa_go')?>" method="post">
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Nama Hari</label>
                  <div class="col-sm-10">
                    <input name="nama_hari" type="text" class="form-control">
                  </div>
                </div>
