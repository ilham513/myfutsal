...
<body>
  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
		...
		<div class="card">
            <div class="card-body">
              <h5 class="card-title">Isi Data Penyewa</h5>

              <!-- General Form Elements -->
              <form action="<?=site_url('admin/add_penyewa_go')?>" method="post">
  		
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Nama Tim</label>
                  <div class="col-sm-10">
                    <input name="nama_penyewa" type="text" class="form-control">
                  </div>
                </div>
