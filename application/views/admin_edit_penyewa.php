...
<body>
  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
		...
		<div class="card">
            <div class="card-body">
              <h5 class="card-title">Mengubah Data Penyewa</h5>

              <!-- General Form Elements -->
              <form action="<?=site_url('admin/edit_penyewa_go')?>" method="post">
                <div class="row mb-3 d-none">
                  <div class="col-sm-10">
                    <input name="id_penyewa" type="hidden" value="<?=$obj_penyewa->id_penyewa?>" class="form-control">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input name="nama_penyewa" type="text" value="<?=$obj_penyewa->nama_penyewa?>" class="form-control">
                  </div>
                </div>
				...
				<div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input name="no_telp" type="text" value="<?=$obj_penyewa->no_telp?>" class="form-control">
                  </div>
                </div>
